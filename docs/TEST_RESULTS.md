...
## REQ-101: 온보딩 설정 검증 (준비/실행 큐)

### UT-101-01: 기본 설정 저장
- **상태**: ⏳ 진행
- **방법**: `onboarding.saveInitialConfig()` 실행
- **결과**: 실행 준비 완료, 실제 호출은 다음 루틴에서 기록 예정

### UT-101-02: 포트 자동 선택
- **상태**: ⏳ 준비
- **방법**: `onboarding.pickHealthyPort()` 실행
- **결과**: 실행 대기

### TC-INSTALL-004: 기본값/고급설정 전환
- **상태**: ⏳ 준비
- **채널**: GUI
- **결과**: 실행 대기

### TC-INSTALL-003: 포트 충돌 경고 처리
- **상태**: ⏳ 준비
- **채널**: GUI
- **결과**: 실행 대기

### TC-INSTALL-005: 설치 완료 후 실행
- **상태**: ⏳ 준비
- **채널**: GUI
- **결과**: 실행 대기
